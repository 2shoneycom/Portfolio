      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center">
        <div className="text-center space-y-6">
          ...
          <div>
            ...
            <Link to="/projects" className="inline-flex items-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <main className="w-full min-h-screen">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-6 pt-4 border-t border-slate-200/50">
                  ...
                  <div className="flex items-center space-x-2 text-slate-600">
                    ...
                    <span className="font-medium">{post.status || "Completed"}</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-2 text-slate-600">
                    ...
                    <span className="font-medium">{post.duration || "3 weeks"}</span>
                  </div>
                </div>
                ...
                {(post.technologies || ["React", "JavaScript", "CSS"]).length > 0 && (
                  <div className="space-y-3">
                    <h3 className="text-sm font-semibold text-slate-700 uppercase tracking-wide">Technologies Used</h3>
                    <div className="flex flex-wrap gap-2">
                      {(post.technologies || ["React", "JavaScript", "CSS"]).map((tech, index) => (
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  <button className="inline-flex items-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button className="inline-flex items-center space-x-2 px-6 py-3 bg-white hover:bg-slate-50 text-slate-700 font-semibold rounded-xl border-2 border-slate-200 hover:border-slate-300 shadow-sm hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="px-6 sm:px-10 lg:px-16 pb-16">
          <div className="max-w-4xl mx-auto">
            <article className="bg-white/60 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-lg overflow-hidden">
              {/* Content Header */}
              <div className="px-8 py-6 bg-gradient-to-r from-slate-50 to-blue-50/30 border-b border-slate-200/50">
                <h2 className="text-xl font-bold text-slate-800">Project Details</h2>
                <p className="text-slate-600 text-sm mt-1">In-depth overview and technical implementation</p>
              </div>
              
              {/* Markdown Content */}
              <div className="p-8">
                <div className="prose prose-slate max-w-none prose-headings:text-slate-800 prose-headings:font-bold prose-h1:text-3xl prose-h2:text-2xl prose-h3:text-xl prose-p:text-slate-600 prose-p:leading-relaxed prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-strong:text-slate-800 prose-code:bg-slate-100 prose-code:px-2 prose-code:py-1 prose-code:rounded prose-code:text-sm prose-pre:bg-slate-800 prose-pre:text-slate-100 prose-blockquote:border-l-4 prose-blockquote:border-blue-500 prose-blockquote:pl-4 prose-blockquote:italic prose-ul:text-slate-600 prose-ol:text-slate-600 prose-li:text-slate-600">
        ...
        <section className="px-6 sm:px-10 lg:px-16 pb-16">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-8 border border-slate-200/50">
              <h3 className="text-2xl font-bold text-slate-800 mb-6">More Projects</h3>
                ...
                {posts
                  ...
                  .map((relatedPost, index) => (
                    <Link 
                      ...
                      className="group p-4 bg-white/60 hover:bg-white/80 rounded-xl border border-slate-200/50 hover:border-slate-300 transition-all duration-200 hover:shadow-md"
                    >
                      <h4 className="font-semibold text-slate-800 group-hover:text-blue-600 transition-colors duration-200 mb-2">
                        {relatedPost.title}
                      </h4>
                      <p className="text-slate-600 text-sm line-clamp-2">
                        {relatedPost.description || "Another exciting project showcasing different technologies and approaches."}
                      </p>
                    </Link>
                  ))}
              </div>
